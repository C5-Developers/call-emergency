...
export const showIncomingCallDialog = (callType, acceptCallHandler, rejectCallHandler) => {
        ...
        //Remover todos los incoming alerts
...
export const showInfoDialog = (preOfferAnswer) => {
    ...
    if (preOfferAnswer === constants.preOfferAnswer.CALL_REJECTED) {
        infoDialog = elements.getInfoDialog(
            'Llamada rechazada',
            'Destinatario rechazo tu llamada'
        )
    }
    if (preOfferAnswer === constants.preOfferAnswer.CALLEE_NOT_FOUND) {
        infoDialog = elements.getInfoDialog(
            'Destinatario no localizado',
            'Por favor revisa el codigo'
        )
    }

    if (preOfferAnswer === constants.preOfferAnswer.CALLEE_UNAVAILABLE) {
        infoDialog = elements.getInfoDialog(
            'Llamada no es posible',
            'Probablemente el destinaratio se encuentre ocupado. Intenta mas tarde.'
        )
    }
